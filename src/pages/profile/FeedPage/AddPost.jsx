            ...
            <div className="p-4">
                <div className="flex flex-col gap-4 grow">
                    <div className="flex items-center gap-4 grow">
                        <img className="h-14 w-14 rounded-full object-cover" src={localStorage.getItem("image").split(`"`)[1]} alt="profile-img" loading='lazy' />
                        <input className="grow focus:outline-none font-normal text-txt-secondary-color text-lg dark:bg-dark-secondary-background dark:text-dark-txt-secondary-color" placeholder="Write something here" type="text" value={postInputForm.content}
                            onChange={(e) =>
                                setPostInputForm({
                                    ...postInputForm,
