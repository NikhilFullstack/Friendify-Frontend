...
// import { setPostData } from '../../slices/editPostSlice';


// function Post_Template() {

//     const [showEmojis, setShowEmojis] = useState(false);
//     const { signupData, token } = useSelector((store) => store.auth);
//     const { postData } = useSelector((store) => store.editPost);
...
//                         dispatch(
//                             setPostData({
//                                 postData: { ...postData, ...postInputForm, userId: localStorage.getItem("userId") },
//                             })
//                         );
//                         // dispatch(closeEditPostHandler());
